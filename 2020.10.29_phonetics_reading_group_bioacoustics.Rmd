...
date: |
    ...
    | last version of the presentation is available here: [tinyurl.com/y375x94c](tinyurl.com/y375x94c)
output: 
  beamer_presentation:
    df_print: kable
...
qrcode_gen("https://github.com/agricolamz/2020.10.29_phonetics_reading_group_bioacoustics/raw/master/2020.10.29_phonetics_reading_group_bioacoustics.pdf")
dev.off()
```
...
## patterns are easier than human
```{r, cache=TRUE}
...
* ribbed file on their legs, or wings \pause
* some crickets have evolved the strategy of digging a horn-shaped burrow in the earth \pause
